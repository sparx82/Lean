...
namespace QuantConnect.Brokerages
{
    ...
    public class SaxoBrokerageModel : DefaultBrokerageModel
    {
        ...
        public SaxoBrokerageModel(AccountType accountType = AccountType.Margin)
            : base(accountType)
        {
        }
        ...
        {
            var symbol = QuantConnect.Symbol.Create("SPY:arcx", SecurityType.Equity, Market.USA);
